...
public class Game {
    ...
    public static void computerPlacementWhenUserIsFirst(Player user, Player computer) {
    ...
    public static void initGameLoop1(Player user, Player computer, Scanner scanner) {
        ...
        while (true) {
            ...
            //computer place piece when user is first
            computerPlacementWhenUserIsFirst(user, computer);
    ...
    public static void initGameLoop2(Player user, Player computer, Scanner scanner) {
        ...
        winningStrategy1(user, computer, scanner);

        //computer strategy gets picked randomly
//        int randomStrategy = (int) (Math.random() * 5);
//        //make sure strategy 1 will get picked 40% of times
//        if (randomStrategy == 0 || randomStrategy == 1) winningStrategy1(user, computer, scanner);
//        //make sure strategy 2 will get picked 40% of times
//        if (randomStrategy == 2 || randomStrategy == 3) winningStrategy2(user, computer, scanner);
//        //make sure strategy 3 will get picked 20% of times
//        if (randomStrategy == 4) winningStrategy3(user, computer, scanner);


    }


    //winning strategies when computer starts

    //corners strategy - will get picked 40% of times
    public static void winningStrategy1(Player user, Player computer, Scanner scanner) {
        ...
        //check if user placed in middle, if so the computer has to place in the opposite corner
        if (user.positions.contains(5)) {

        }
        //the computer wins by placing in 3 corners
        //if user placed in a corner
        ...
        //user places in middle of row
            ...
            if (closeToWin(computer) != -1) {
                ...
                //place in the middle and get to 2 way win in an X shape
                System.out.println("Computer placing:");
                placePiece(5, computer);
                printGameBoard();
    ...
    //recieves input position from user and places in it
